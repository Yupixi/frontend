...
export type PaymentIntent = {
  id: string
  reference: string
  kind: 'CREDIT_PACK' | 'BOOST_PACK' | 'SHOP_SUBSCRIPTION' | 'BADGE_SUBSCRIPTION'
  product: string
...
export type PaymentRequest = { kind: 'CREDIT_PACK' | 'BOOST_PACK' | 'SHOP_SUBSCRIPTION' | 'BADGE_SUBSCRIPTION'; product: string; listingId?: string }
